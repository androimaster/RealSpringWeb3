...
public class NosessionController {
    ...
    public String registForm(Model model, HttpServletRequest req, HttpServletResponse res, String nullStr) { 
        return "home/registForm";
    }

    @RequestMapping("nosession/doReg")
    public String doReg(@RequestParam Map<String, String> model, HttpServletRequest req, HttpServletResponse res, String nullStr) {
        System.out.println(model.toString());
        return (String) studyService.doReg(model);
    }
    
    @RequestMapping("nosession/loginForm")
    public String loginForm(@RequestParam Map<String, String> map, Model model, HttpServletRequest req, HttpServletResponse res, String nullStr) {
